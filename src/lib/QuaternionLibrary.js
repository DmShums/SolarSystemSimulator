...
export class RotationQuaternion {
    ...
    get GetQ_0() { return this.q_0; }
    get GetQ_1() { return this.q_1; }
    get GetQ_2() { return this.q_2; }
    get GetQ_3() { return this.q_3; }

    set SetQ_0(newq_0) { this.q_0 = newq_0; }
    set SetQ_1(newq_1) { this.q_1 = newq_1; }
    set SetQ_2(newq_2) { this.q_2 = newq_2; }
    set SetQ_3(newq_3) { this.q_3 = newq_3; }

    PostMultiply(anotherQuaternion) {
        const t_0 = (this.q_0 * anotherQuaternion.GetQ_0() - this.q_1 * anotherQuaternion.GetQ_1() - this.q_2 * anotherQuaternion.GetQ_2() - this.q_3 * anotherQuaternion.GetQ_3());
        const t_1 = (this.q_0 * anotherQuaternion.GetQ_1() + this.q_1 * anotherQuaternion.GetQ_0() - this.q_2 * anotherQuaternion.GetQ_3() + this.q_3 * anotherQuaternion.GetQ_2());
        const t_2 = (this.q_0 * anotherQuaternion.GetQ_2() + this.q_1 * anotherQuaternion.GetQ_3() + this.q_2 * anotherQuaternion.GetQ_0() - this.q_3 * anotherQuaternion.GetQ_1());
        const t_3 = (this.q_0 * anotherQuaternion.GetQ_3() - this.q_1 * anotherQuaternion.GetQ_2() + this.q_2 * anotherQuaternion.GetQ_1() + this.q_3 * anotherQuaternion.GetQ_0());
        return RotationQuaternion.ConstructQuaternionFromAxes(t_0, t_1, t_2, t_3);
    }

    PreMultiply(anotherQuaternion) {
        const t_0 = (this.q_0 * anotherQuaternion.GetQ_0() - this.q_1 * anotherQuaternion.GetQ_1() - this.q_2 * anotherQuaternion.GetQ_2() - this.q_3 * anotherQuaternion.GetQ_3());
        const t_1 = (this.q_1 * anotherQuaternion.GetQ_0() + this.q_0 * anotherQuaternion.GetQ_1() - this.q_3 * anotherQuaternion.GetQ_2() + this.q_2 * anotherQuaternion.GetQ_3());
        const t_2 = (this.q_2 * anotherQuaternion.GetQ_0() + this.q_3 * anotherQuaternion.GetQ_1() + this.q_0 * anotherQuaternion.GetQ_2() - this.q_1 * anotherQuaternion.GetQ_3());
        const t_3 = (this.q_3 * anotherQuaternion.GetQ_0() - this.q_2 * anotherQuaternion.GetQ_1() + this.q_1 * anotherQuaternion.GetQ_2() + this.q_0 * anotherQuaternion.GetQ_3());
        return RotationQuaternion.ConstructQuaternionFromAxes(t_0, t_1, t_2, t_3);
    }
    ...
    RotateVectorActive(vectorToRotate) {
        const vectorAsQuat = RotationQuaternion.ConstructQuaternionFromAxes(0, vectorToRotate.GetX(), vectorToRotate.GetY(), vectorToRotate.GetZ());
    ...
    ApplyToThreeObject(threeObject) {
        const threeQuat = new THREE.Quaternion(this.q_1, this.q_2, this.q_3, this.q_0);
        threeObject.applyQuaternion(threeQuat);
    }
}
